  ...
  return (
          ...
          <div className="row g-0">
            ...
            <div className="col-md-8 ">
              <div className="card-body ">
                <h1 className="card-title text-center">منصة الارشاد الاكاديمى</h1>
                <hr />
                <p className="card-text " dir="rtl">
                  <strong className="text-right">
                    يهدف نظام التسجيل الالكتروني الى تسهيل عملية تسجيل المقررات
                    الدراسية للطالب/الطالبة وامكانية تعديلها في أى وقت خلال الفترة
                    المسموح بها للتسجيل
                  </strong>
                </p>
    ...
    <footer className="text-center text-lg-start  ">
      ...
      <div className="text-center  text-light p-3 fw-bold fs-5">
        2024 © جميع الحقوق محفوظة لكلية الحاسبات والذكاء الاصطناعى بجامعة الفيوم
      </div>
      {/* Copyright */}
    </footer>
  </>
